...
class Particle {
    ...
    draw() {
        ...
        ctx.fillStyle = isLight ? 'rgba(251, 192, 45, 0.6)' : 'rgba(255, 235, 59, 0.7)';
        ctx.save();
...
function animate() {
    const isLight = document.body.classList.contains('light-mode');
    ctx.fillStyle = isLight ? 'rgba(255, 253, 231, 0.15)' : 'rgba(26, 26, 46, 0.15)';
...
viewButtons.forEach(button => {
    button.addEventListener('click', function() {
        ...
        galleries.forEach(gallery => {
            ...
            gridContainer.classList.remove('gallery-grid', 'gallery-masonry', 'gallery-carousel', 'gallery-slideshow');
...
setTimeout(() => {
    ...
    notification.style.cssText = `
                ...
                text-align: center;
            `;
    notification.textContent = '📸 Welcome to the Gallery! Click any image to view in fullscreen';
